...
<div style="text-align:center;margin-bottom:3.5rem;width:100%;display:flex;justify-content:center;align-items:center;gap:1rem;">
    <x-dynamic-component :component="'heroicon-o-' . $service->icon" style="width:3rem;height:3rem;" />
...
<div style="width:100%;max-width:80rem;padding:1.5rem;border-radius:1rem;box-shadow:0 4px 6px rgba(0,0,0,0.1);background:#fff;overflow-x:auto;-webkit-overflow-scrolling:touch;margin:0 auto;">
    ...
    @else
        <p style="color:#6b7280;">No raw materials available for this service.</p>
    @endif
</div>
...
<div style="width:100%;max-width:80rem;padding:1.5rem;border-radius:1rem;box-shadow:0 4px 6px rgba(0,0,0,0.1);background:#fff;overflow-x:auto;-webkit-overflow-scrolling:touch;margin:0 auto;">
    ...
    <table class="responsive-table" style="width:100%;border-collapse:collapse;border:1px solid #e5e7eb;table-layout:fixed;">
        <thead>
            <tr style="background-color:#f3f4f6;">
                <th style="border:1px solid #e5e7eb;padding:0.5rem 1rem;text-align:left;">Service</th>
                <th style="border:1px solid #e5e7eb;padding:0.5rem 1rem;text-align:left;">Quantity</th>
                <th style="border:1px solid #e5e7eb;padding:0.5rem 1rem;text-align:left;">Cost per Unit</th>
                <th style="border:1px solid #e5e7eb;padding:0.5rem 1rem;text-align:left;">Markup per Unit (₱)</th>
                <th style="border:1px solid #e5e7eb;padding:0.5rem 1rem;text-align:left;">Selling Price per Unit</th>
        ...
        <tbody>
            <tr id="quotationRow">
                ...
                <td id="quoteCostPerPiece" style="border:1px solid #e5e7eb;padding:0.5rem 1rem;" data-label="Cost per Unit">₱0.00</td>
...
addRawBtn.addEventListener('click', () => {
    ...
    row.innerHTML = `
        <td class="border px-4 py-2" data-label="Raw Material">${rawName}</td>
        <td class="border px-4 py-2" data-label="Quantity">
            <input type="number" min="0" value="0" class="quantity-input" style="width:70px;padding:0.25rem 0.5rem;border:1px solid #d1d5db;border-radius:0.375rem;">
        </td>
        <td class="border px-4 py-2" data-label="Unit Price">
            <input type="number" step="0.01" value="${unitPrice}" class="unit-price-input" readonly style="width:100px;padding:0.25rem 0.5rem;border:1px solid #d1d5db;border-radius:0.375rem;">
        </td>
        <td class="border px-4 py-2 total-price" data-label="Total Price">₱0.00</td>
        <td class="border px-4 py-2" data-label="Action">
            <button type="button" class="remove-btn text-white px-2 py-1 rounded hover:bg-red-600 transition" style="background-color: rgb(239 68 68);">Remove</button>
        </td>
    `;
