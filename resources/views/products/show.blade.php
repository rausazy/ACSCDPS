...
<div class="min-h-screen flex flex-col items-center py-16 px-4 sm:px-6 lg:px-8">
    ...
    <div style="width:100%;max-width:80rem;padding:1.5rem;border-radius:1rem;box-shadow:0 4px 6px rgba(0,0,0,0.1);background:#fff;overflow-x:auto;-webkit-overflow-scrolling:touch;margin:0 auto;">
        ...
        @if($rawMaterials->count())
            ...
            <!-- ✅ Cost Summary Table under raw materials table -->
                ...
                <table style="width:100%; border-collapse:collapse; border:1px solid #e5e7eb; table-layout:fixed;">
                    <thead>
                        <tr style="background-color:#f9fafb; color:#374151;">
                            <th style="border:1px solid #e5e7eb; padding:0.75rem 1rem; text-align:left; font-size:0.875rem; font-weight:700;">
                                Total Job Cost
                            </th>
                            <th style="border:1px solid #e5e7eb; padding:0.75rem 1rem; text-align:left; font-size:0.875rem; font-weight:700;">
                                Direct Labor
...
// ✅ calculate labor based on Hours + Minutes
...
// ✅ calculate overhead based on Hours + Minutes
...
function updateTotals() {
    ...
    if (overallCostEl) overallCostEl.innerText = '₱' + totalCost.toFixed(2);
